pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~test_matrice.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~test_matrice.adb");
...
package body ada_main is
   ...
   E161 : Short_Integer; pragma Import (Ada, E161, "matrice_E");
