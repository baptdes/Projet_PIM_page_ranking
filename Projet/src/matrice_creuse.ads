...
package Matrice_creuse is
    ...
    package Hachage is new TH(Capacite => Taille, T_Cle => Integer, T_Valeur => Float, fonction_hachage => Fonction_hachage);
    ...
    -- On léve l'exception Taille_Hors_Capacite si la taille demandé dépasse la capacités
